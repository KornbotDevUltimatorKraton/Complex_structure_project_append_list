...
if data.get('email') in list(project_components):
            ...
            if data2.get('project_name') in list(project_components.get(data.get('email'))):   
                  print(data2)
                  project_components.get('kornbot380@hotmail.com').get(data2.get('project_name')).get(data2.get('category_component'))[0][data2.get('component_selected')] = data2.get('component_spec_data')  
